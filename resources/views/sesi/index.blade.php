  ...
  <form class="form-masuk" id="loginForm" method="post" action="/login">
    ...
    <div class="form-group">
      <input
        ...
        name="email"
        id="email"
        placeholder="Masukkan Email" class="form-control @error('email')is-invalid @enderror" value="{{ old('email') }}" required
      />
      @error('email')
...
<div class="scan text-center mt-5">
  ...
  <div class="digides-digital">
    <div class="d-flex justify-content-center align-items-center">
        ...
        <p class="m-0">2024 Powered by <span id="pt">Baju Bodo</span> dan <span id="pt">Jas Tutup Indonesia</span></p>
    </div>
  </div>
</div>
</div>
